...
namespace Toolsmith.Utils {
    public static class ToolsmithConstants {
        ...
        public const string LightTreatementOverlayPath = "toolsmith:item/handles/lightOverlay";
        public const string DarkTreatementOverlayPath = "toolsmith:item/handles/darkOverlay";
