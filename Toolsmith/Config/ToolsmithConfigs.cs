...
namespace Toolsmith.Config {
    public class ToolsmithConfigs { //TODO for tomorrow: Time to refactor the original config file woo. Probably can/should clean this up...
        ...
        public Dictionary<string, HandleStatPair> BaseHandleRegistry = new() { //Both for the Handles and Bindings, it should be simple enough to just find each
            ...
            ["crudehandle"] = new() { handleStatTag = "crude", canHaveGrip = true, gripShapePath = "toolsmith:shapes/item/crudehandle-wrap" },
            ["handle"] = new() { handleStatTag = "handle", canHaveGrip = true, gripShapePath = "toolsmith:shapes/item/handle-wrap", canBeTreated = true },
            ["carpentedhandle"] = new() { handleStatTag = "professional", canHaveGrip = true, gripShapePath = "toolsmith:shapes/item/carpentedhandle-wrap", canBeTreated = true, dryingTimeMult = 2.0f }
        };

        public Dictionary<string, GripStatPair> GripRegistry = new() {
            ["flaxtwine"] = new() { gripStatTag = "twine" },
            ["linen-diamond-down"] = new() { gripStatTag = "cloth" },
            ["linen-normal-down"] = new() { gripStatTag = "cloth" },
            ["linen-offset-down"] = new() { gripStatTag = "cloth" },
            ["linen-square-down"] = new() { gripStatTag = "cloth" },
            ["leather-normal-plain"] = new() { gripStatTag = "leather" },
            ["leather-normal-orange"] = new() { gripStatTag = "leather" },
            ["leather-normal-black"] = new() { gripStatTag = "leather" },
            ["leather-normal-red"] = new() { gripStatTag = "leather" },
            ["leather-normal-blue"] = new() { gripStatTag = "leather" },
            ["leather-normal-purple"] = new() { gripStatTag = "leather" },
            ["leather-normal-pink"] = new() { gripStatTag = "leather" },
            ["leather-normal-white"] = new() { gripStatTag = "leather" },
            ["leather-normal-yellow"] = new() { gripStatTag = "leather" },
            ["leather-normal-gray"] = new() { gripStatTag = "leather" },
            ["leather-normal-green"] = new() { gripStatTag = "leather" },
            ["leather-sturdy-plain"] = new() { gripStatTag = "sturdy" }
        };
